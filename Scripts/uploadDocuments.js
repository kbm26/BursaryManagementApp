document
  ...
  .addEventListener("submit", function (event) {
    ...
    const academicTranscriptFile = document.getElementById(
    ...
    fetch(
      `https://bursarywebapp.azurewebsites.net/api/Documents/UploadStudentDocuments?studentIDNum=${studentIDNum}`,
      requestOptions
    )
      .then((response) => {
        if (response.ok) {
          alert("Student Documents uploaded successfully.");
          document.getElementById("successMessage").textContent =
